...
def resources_page():
    ...
    with tab3:
        ...
        **Synthetic Dataset Results:**
        ...
        |-------|----------|-----------|---------|----------|---------|
        | CatBoost | 50.0% | 34.4% | 54.9% | 42.3% | 51.6% |
        | Random Forest | 42.71% | 45% | 71% | 65.15% | 49.73% |
        | SVM | 49.33% | 33.0% | 50.0% | 39.58% | 50.0% |
        | Logistic Regression | 49.96% | 33.38% | 50.33% | 40.14% | 50.0% |
        ...
        **European Dataset Results:**
        ...
        | Model | Accuracy | Precision | Recall | F1-Score | AUC-ROC |
        |-------|----------|-----------|---------|----------|---------|
        | CatBoost | 99.9% | 99.9% | 99.9% | 99.9% | 99.9% |
        | Random Forest | 98.59% | 99.9% | 99.9% | 99.9% | 99.95% |
        | SVM | 99.96% | 99.96% | 99.96% | 99.96% | 99.96% |
        | Logistic Regression | 99.83% | 99.91% | 99.76% | 99.83% | 99.83% |
        | Neural Network | 95.44% | 97.18% | 97.18% | 97.18% | 99.13% |
        """)
